...
import com.switch_and_trade.switch_and_trade_artifact.modelo.Rol;
import com.switch_and_trade.switch_and_trade_artifact.modelo.Usuario;
import com.switch_and_trade.switch_and_trade_artifact.repositorio.UsuarioRepositorio;
...
public class UsuarioServicio implements UserDetailsService {
    ...
    @Transactional
    public void crearUsuario(Usuario dto) {
    ...
    @Transactional
    public void editarUsuario(Usuario dto) {
        Usuario usuario = new Usuario();
        usuario.setEmail(dto.getEmail());
